...
<div class="body0">
    ...
    <div class="oneright"	 	>
        ...
        <div class="allask">
           ...
           // $query='select * from message order by rid desc limit 0, 3';
            //$query='select * from message order by rid desc limit $offset $pagesize';
           // $query = "SELECT * FROM message ORDER BY rid DESC"." LIMIT ".($curpage -1)*$pagesize.", $pagesize";
            $query="select * from message order by id desc limit $offset , $pagesize";
            $result=mysqli_query($link,$query);

           // $query1="select rep.contents from message mes inner join  reply rep on mes.id = rep.m_id ";
...
*/
                        ...
                        if($hi['m_id']==$ai['id'])
                        {
                          ...
                          echo "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            ...
                            <div id=\"win\">
                                ...
                                <div id=\"content\">
                                    <form action=\"zxjlcheck.php\" method='post'>
                                      <input type=\"hidden\" name=\"userid\" value=\"".$hi['id']."\">
            ...
            for($i=1;$i<=$pages;$i++)
            {   //循环显示，每个链接指定curPage属性为其指向的页数就可以了
