	...
	<div class="row h_menu">
		<nav class="navbar navbar-default navbar-left" role="navigation">
		    ...
		    <!--<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">-->
		      <!--<ul class="nav navbar-nav">-->
		        ...
		        <!--<li><a href="technology.html">主讲教师</a></li>-->
		        <!--<li><a href="about.html">课程简介</a></li>-->
		        <!--<li><a href="blog.html">课程难点</a></li>-->
				<!--<li><a href="thing">课程课件</a></li>-->
		        <!--<li><a href="contact.html">在线交流</a></li>-->
		      <!--</ul>-->
		...
		<div class="soc_icons navbar-right">
			<ul class="list-unstyled text-center">
				...
				<!--<li><a href="#" style="background-color: #F05252;" class="sail"><i class="fa fa-linkedin#">注册</i></a></li>-->
				<?php if(null != $_SESSION['name'] ): ?><li><a href="#" target="_blank" style="width:6em;"><i class="fa fa-youtube#"><?php echo $_SESSION['name'] ?></i></a></li>
					<li><a href="Home/Index/logout" target="_blank"><i class="fa fa-linkedin#">注销</i></a></li>
				<?php else: ?>
					<li><a href="Home/Index/login" target="_blank"><i class="fa fa-youtube#">登录</i></a></li>
					<li><a href="Home/Index/register" target="_blank"><i class="fa fa-linkedin#">注册</i></a></li><?php endif; ?>
			</ul>
		</div>
	</div>
	<div class="clearfix"></div>
...
<div class="container ">
	<div class="jumbotron lsail">
		<h1 style="text-align: center;font-family: 微软雅黑;color:black;">注册</h1>
		<div >
		...
		<br>
		<br>
		<form class="form-horizontal" role="form" method="post" action="/muke/Home/Index/regcheck" onsubmit="return check();">
			...
			<div class="form-group">
				<label for="lastname" class="col-sm-4 control-label text-info" style="font-family: 微软雅黑; font-size: 1.5rem;">密码确认</label>
				<div class="col-sm-4">
					<input type="password" class="form-control" name="confirm" id="lastname" placeholder="请输入密码">
				</div>
			</div>
			...
			<div class="form-group">
				<div class="col-sm-offset-5 col-sm-10">
					<button type="Submit" name="Submit" class="btn btn-lg btn-info"  value="注册">
						<span class="glyphicon glyphicon-user"></span> User 注册
					</button>
				</div>
			</div>
		</form>
