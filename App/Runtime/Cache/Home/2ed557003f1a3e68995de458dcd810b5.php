...
<div class="main_bg"><!-- start main -->
	<div class="container">
		<div class="about details row">
			...
			<img src="/muke/App/Common/Common/images/det_pic.jpg" alt="" class="img-responsive"/>
	...
	<div class="container">
		<div class="row  footer">
			<div class="copy text-center">
				<p class="link"><span>&#169; All rights reserved. More Templates <a href="http://www.cssmoban.com/" target="_blank" title="ģ��֮��">ģ��֮��</a> - Collect from <a href="http://www.cssmoban.com/" title="��ҳģ��" target="_blank">��ҳģ��</a></span></p>
			</div>
		</div>
	</div>
</div>
