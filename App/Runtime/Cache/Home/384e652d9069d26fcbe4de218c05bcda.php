			...
			<nav class="navbar navbar-default navbar-left" role="navigation">
				...
				<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
					<ul class="nav navbar-nav">
						...
						<li class="active"><a href="blog">课程难点</a></li>
	...
	<div class="container">
		<div class="main row">
			<div class="col-md-8 blog_left">
				<h4><a href="single-page.html">细数那些离散的小难点(一)</a></h4>
				<a href="single-page.html"><img src="/muke/App/Common/Common/images/blog_pic1.jpg" alt="" class="blog_img img-responsive"/></a>
				<div class="blog_list">
				...
				<h4><a href="single-page.html">细数那些离散的小难点(二)</a></h4>
				<a href="single-page.html"><img src="/muke/App/Common/Common/images/blog_pic2.jpg" alt="" class="blog_img img-responsive"/></a>
				<div class="blog_list">
					<ul class="list-unstyled">
						<li><i class="fa fa-calendar-o"></i><span>June 3, 2013</span></li>
						<li><a href="#"><i class="fa fa-comment"></i><span>Comments</span></a></li>
			...
			<div class="col-md-4 blog_right">
				...
				<ul class="ads_nav list-unstyled">
					<h4>Ads 125 x 125</h4>
					<li><a href="#"><img src="/muke/App/Common/Common/images/ads_pic.jpg" alt=""> </a></li>
					<li><a href="#"><img src="/muke/App/Common/Common/images/ads_pic.jpg" alt=""> </a></li>
					<li><a href="#"><img src="/muke/App/Common/Common/images/ads_pic.jpg" alt=""> </a></li>
					<li><a href="#"><img src="/muke/App/Common/Common/images/ads_pic.jpg" alt=""> </a></li>
					<div class="clearfix"></div>
