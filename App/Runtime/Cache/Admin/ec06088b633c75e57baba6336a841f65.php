...
<link href="/muke/App/Admin/Common/css/font-awesome.css" rel="stylesheet">
<!-- jQuery -->
            ...
            <ul class="nav navbar-nav navbar-right">
				<li class="dropdown">
	        		...
	        		<ul class="dropdown-menu">
						...
						<li class="avatar">
							<a href="#">
								<img src="/muke/App/Admin/Common/images/1.png" alt=""/>
								<div>New message</div>
						...
						<li class="avatar">
							<a href="#">
								<img src="/muke/App/Admin/Common/images/2.png" alt=""/>
								<div>New message</div>
								<small>1 minute ago</small>
								<span class="label label-info">NEW</span>
							</a>
						...
						<li class="avatar">
							<a href="#">
								<img src="/muke/App/Admin/Common/images/3.png" alt=""/>
								<div>New message</div>
								<small>1 minute ago</small>
							</a>
						</li>
						<li class="avatar">
							<a href="#">
								<img src="/muke/App/Admin/Common/images/4.png" alt=""/>
								<div>New message</div>
								<small>1 minute ago</small>
							</a>
						</li>
						<li class="avatar">
							<a href="#">
								<img src="/muke/App/Admin/Common/images/5.png" alt=""/>
								<div>New message</div>
								<small>1 minute ago</small>
							</a>
						</li>
						<li class="avatar">
							<a href="#">
								<img src="/muke/App/Admin/Common/images/pic1.png" alt=""/>
								<div>New message</div>
								<small>1 minute ago</small>
							</a>
						</li>
			    ...
			    <li class="dropdown">
	        		<a href="#" class="dropdown-toggle avatar" data-toggle="dropdown"><img src="/muke/App/Admin/Common/images/1.png" alt=""/><span class="badge">9</span></a>
	        		<ul class="dropdown-menu">
...
<script src="/muke/App/Admin/Common/js/metisMenu.min.js"></script>
<script src="/muke/App/Admin/Common/js/custom.js"></script>
